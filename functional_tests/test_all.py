# [Created by SkaeX @ 2016-02-22 16:21:23] 
# -*- coding: utf-8 -*-
...
class HomeNewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_home_title(self):
        ...
        self.assertIn("TELA", self.browser.title)
    ...
    def test_internationalization(self):
        for lang, h1_text in [('en', "TELA Management Information System"),
                                    ('fr', "TELA Systeme d'Information de Gestion")]:
            activate(lang)
            self.browser.get(self.get_full_url("home"))
            h1 = self.browser.find_element_by_tag_name("h1")
