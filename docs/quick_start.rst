...
This project is named *TelaMIS*, so if you are using this 
...
You must add the lines: ::
    ...
    export DJANGO_SETTINGS_MODULE="TelaMIS.settings.development"
...
where you have to add the lines::
    ...
    export DJANGO_SETTINGS_MODULE="TelaMIS.settings.testing"
    export SECRET_KEY="your_secret_django_key"
...
The default language for this Project is **English**, and we use internatinalization to translate the text into French.
...
Go to the terminal, inside the tela-mis folder and create the files to translate with::
 
    $ python manage.py makemessages -l fr
 
change the language "fr" for your selected language.
 
Next, go to the locale folder of your language::
 
    $ cd tela-mis/locale/fr/LC_MESSAGES
 
where tela-mis is your project folder. You have to edit the file *django.po* and translate the strings. You can find more information about how to translate the strings |translation_strings_post|.
...
- in **test_internationalization**, update your languages with the translation of title text, here "!"
